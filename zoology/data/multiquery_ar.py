...
def multiquery_ar(
    ...
    **kwargs,
    ...
    # Replace non-query filler tokens with non-zero IDs that cannot equal any active key
    # in the same example, so suffix key identity remains an unambiguous query signal.
